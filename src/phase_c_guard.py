...
async def check_input_rail(text: str, rails=None) -> dict:
    ...
    fallback_keywords = ["bỏ qua", "ignore", "dan", "đóng vai", "thơ", "nấu", "bitcoin", "ethereum", "phương trình", "phim", "override", "admin", "ceo", "toàn bộ thông tin"]
    fallback_block = any(kw in text.lower() for kw in fallback_keywords)
    
    blocked = any(kw in response_text.lower() for kw in refuse_keywords) or fallback_block
    return {
        "allowed":        not blocked,
